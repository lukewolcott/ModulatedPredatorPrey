...
The following figure shows a 20-day slices of this dataset, and we can see that there is indeed a circle corresponding to the classic delayed population dynamics.

```{r, echo=TRUE}
# look for a good windows, write down the days for them
# make a new data set from d above, filtering for those days
# plot as above

# maybe also show the barcode?
```
